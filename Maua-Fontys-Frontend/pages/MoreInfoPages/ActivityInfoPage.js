...
const ActivityInfoPage = ({route}) => {
    ...
    return (
        <ScrollView>
            ...
            <Text style={customStyles.body_text}>{t('Activity information')}</Text>
            ...
            <View style={customStyles.card_content}>
                ...
                <Text style={customStyles.card_title}>{t('Start Time')}</Text>
                <Text style={customStyles.card_message}>{info.startTime.substring(0, 16)}</Text>

                <Text style={customStyles.card_title}>{t('End Time')}</Text>
                <Text style={customStyles.card_message}>{info.endTime.substring(0, 16)}</Text>

                <Text style={customStyles.card_title}>{t('Location')}</Text>
                <Text style={customStyles.card_message}>{info.location}</Text>

                <Text style={customStyles.card_title}>{t('Description')}</Text>
