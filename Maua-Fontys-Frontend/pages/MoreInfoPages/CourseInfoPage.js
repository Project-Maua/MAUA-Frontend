...
const CourseInfoPage = ({route}) => {
    ...
    return (
        <ScrollView>
            ...
            <Text style={customStyles.body_text}>{t('Course information')}</Text>
          ...
          <View style={customStyles.description_card_content}>
                <Text style={customStyles.description_card_title}>{t('Duration')}</Text>
                <Text style={customStyles.description_card_message}>{info.duration}</Text>

                <Text style={customStyles.description_card_title}>{t('Tuition')}</Text>
                <Text style={customStyles.description_card_message}>{'R$ ' + info.tuition}</Text>

                <Text style={customStyles.description_card_title}>{t('Shift')}</Text>
